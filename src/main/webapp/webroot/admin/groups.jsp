                ...
                <table class="table is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <c:forEach var="group" items="${groups}" varStatus="loop">
                        <tr>
                            ...
                            <td class="has-text-right">${group.id}</td>
                            <td><a href="${pageContext.request.contextPath}/view?tab1=admin&tab2=groups&tab3=modify&action=form&groupId=${group.id}">${group.name}</a></td>
