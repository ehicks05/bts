    ...
    <script>
        function deleteLog(name)
        {
            if (confirm('Are you sure?'))
                location.href="${pageContext.request.contextPath}/admin/logs/delete?logName=" + name;
        }
    </script>
</head>
<body>
                    ...
                    <c:forEach var="log" items="${logs}" varStatus="loop">
                        <tr>
                            ...
                            <td class="has-text-centered">
                                <a href="${pageContext.request.contextPath}/admin/logs/viewLog?logName=${log.name}">
                                    <i class="fas fa-file-alt"></i></a>
                            </td>
                            <td class="has-text-centered">
                                <a href="${pageContext.request.contextPath}/admin/logs/viewLogPretty?logName=${log.name}">
