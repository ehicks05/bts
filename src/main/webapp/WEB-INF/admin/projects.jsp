    ...
    <script>
        function deleteProject(projectId)
        {
            if (confirm('Are you sure?'))
                location.href="${pageContext.request.contextPath}/admin/projects/delete?projectId=" + projectId;
        }
    </script>
</head>
<body>
...
<div id="createProjectDialog" class="modal">
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body">
            <form id="frmCreateProject" name="frmCreateProject" method="post" action="${pageContext.request.contextPath}/admin/projects/create">
